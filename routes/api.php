...
use App\Http\Controllers\Api\StoreViewStatsController;
...
Route::get('stores/test-changes', [StoreViewStatsController::class, 'index'])
    ->middleware(['affiliate.key', 'throttle:120,1'])
    ->name('api.stores.test_changes');
